...
class __TwigTemplate_3e90921a6891faa48ce9b223079e4b9f7623d99c97dac92ee210818c0b42836b extends \Twig\Template
{
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null))))) : ("")), 6 => "clearfix"];
        // line 80
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->attachLibrary("classy/node"), "html", null, true));
        echo "
<article";
        // line 81
...
";
    ...
    {
        return new Source("", "core/themes/bartik/templates/node.html.twig", "/var/www/drupaltest/core/themes/bartik/templates/node.html.twig");
    }
}

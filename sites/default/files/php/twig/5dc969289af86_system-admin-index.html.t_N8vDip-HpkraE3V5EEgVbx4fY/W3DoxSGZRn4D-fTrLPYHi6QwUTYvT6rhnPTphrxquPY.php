...
class __TwigTemplate_c7b1890b4deb325a5448d3609c2bd4e2ebecd630903c61cf6a1d7fce336861a3 extends \Twig\Template
{
  ...
  ";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["blocks"]) {
            // line 19
            echo "    <div class=\"";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($context["position"]), "html", null, true));
            echo " clearfix\">
      ";
            // line 20
            $context['_parent'] = $context;
...
";
    ...
    {
        return new Source("", "core/themes/stable/templates/admin/system-admin-index.html.twig", "/var/www/drupaltest/core/themes/stable/templates/admin/system-admin-index.html.twig");
    }
}
